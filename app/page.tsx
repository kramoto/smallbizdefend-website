      ...
      <section className="py-16 bg-slate-50">
        <div className="container px-4 md:px-6">
          <div className="max-w-3xl mx-auto text-center">
            <h2 className="text-3xl font-bold tracking-tight mb-6">Your Trusted Partner in Cybersecurity</h2>
            <p className="text-muted-foreground mb-8">
              SmallBizDefend.com was founded by an IT Security Consultant and Auditor with over 15 years of experience
              in the trenches, helping businesses of all sizes navigate the complexities of information security. This
              platform was born from a passion for making robust cybersecurity accessible to small business owners – the
